...
//    public boolean bProcessesGsensorDataByApp = false;   //有APP上层来处理G-Sensor数据


//    public boolean bAdjGsensorData = true; //SDK 来校准 G-sensor
...
//                                    }
//                                    if (!bFlash) {
//                                        wifiCamera.naSetGsensor2SDK(xx + nAdjAngle, yy, zz);
//                                    }
//                                    nXX_pre = xx;
//                                    nYY_pre = yy;
//                                    nZZ_pre = zz;
//                                } else {
//                                    wifiCamera.naSetGsensor2SDK(xx, yy, zz);
//                                }
//                            }
//                        }
//                    }
...
//        public int nInx2;
        ...
        public JoyFile(String sPath_, String sFileName_, int nLength_) {
            sPath = sPath_;
